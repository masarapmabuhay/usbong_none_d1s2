...
public class PurchaseLanguageBundleListAdapter extends BaseAdapter
{
	...
	public PurchaseLanguageBundleListAdapter(Activity a, Bundle ownedItems, IInAppBillingService mS)
	{
		...
		languageBundleList[0][1] = "Owned"; //UsbongConstants.DEFAULT_PRICE; //updated by Mike, 20160612
		languageBundleList[1][1] = UsbongConstants.DEFAULT_PRICE;

        //Reference: http://stackoverflow.com/questions/23024831/android-shared-preferences-example
        //; last accessed: 9 June 2015
        //answer by Elenasys
        //added by Mike, 20160612
        SharedPreferences.Editor editor = myActivity.getSharedPreferences(UsbongConstants.MY_PURCHASED_ITEMS, android.content.Context.MODE_PRIVATE).edit();
