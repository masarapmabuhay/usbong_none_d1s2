...
import usbong.android.none_d1s2.R;
import usbong.android.none_d1s2.UsbongDecisionTreeEngineActivity;
...
public class UsbongUtils {		
	...
	public static String DEFAULT_UTREE_TO_LOAD="dahonNone_d1s2"; //updated by Mike, 20160612
	public static String BASE_FILE_PATH = Environment.getExternalStorageDirectory()+"/usbong_none_d1s2/";
	...
	public final static String myPackageName="usbong.android.none_d1s2";
	public static String myAppTreeFolder = "/usbong_none_d1s2/usbong_trees/";
